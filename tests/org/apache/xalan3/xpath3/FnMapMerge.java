...
/**
 * XPath 3.1 function map:merge test cases.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class FnMapMerge extends XSLTransformTestsUtil {        
    
    private static final String XSL_TRANSFORM_INPUT_DIRPATH = XSLConstants.XSL_TRANSFORM_INPUT_DIRPATH_PREFIX + "fn_map_merge/";
    
    private static final String XSL_TRANSFORM_GOLD_DIRPATH = XSLConstants.XSL_TRANSFORM_GOLD_DIRPATH_PREFIX + "fn_map_merge/gold/";
    ...
    @Test
    public void xslFnMapMergeTest1() {
    ...
    @Test
    public void xslFnMapMergeTest2() {
    ...
    @Test
    public void xslFnMapMergeTest3() {
    ...
    @Test
    public void xslFnMapMergeTest4() {
    ...
    @Test
    public void xslFnMapMergeTest5() {
    ...
    @Test
    public void xslFnMapMergeTest6() {
    ...
    @Test
    public void xslFnMapMergeTest7() {
