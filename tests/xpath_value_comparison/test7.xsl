...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="currentDateStr" select="java:format(java:java.text.SimpleDateFormat.new('yyyy-MM-dd'), 
                                                        java:org.apache.xalan3.util.XSLTransformTestsUtil.getCurrentDate())"/>
                                                        
   <xsl:variable name="timeZoneOffsetStr" select="java:org.apache.xalan3.util.XSLTransformTestsUtil.getDefaultTimezoneOffsetStr()"/>
