...
public class FuncXmlToJson extends JsonFunction
{
    ...
    public XObject execute(XPathContext xctxt) throws javax.xml.transform.TransformerException
    {
        ...
        if (m_arg1 != null) {
           ...
           if (!(arg1Obj instanceof XPathMap)) {
        	  throw new javax.xml.transform.TransformerException("FOAP0001 : An XPath 3.1 function 'xml-to-json' optional second "
        	  		                                                                                                     + "argument needs to be an xdm map, that specifies options for "
        	  		                                                                                                     + "the function call 'xml-to-json'.", srcLocator); 
           }
           else {
        ...
        if (optionsMap != null) {
           ...
           if (nativeMap.size() != 1) {
        	  throw new javax.xml.transform.TransformerException("FOAP0001 : An XPath 3.1 function 'xml-to-json' second argument, "
        	  		                                                                                                   + "needs to be an xdm map with only one entry having a key "
        	  		                                                                                                   + "named 'indent' with an XML schema type boolean.", srcLocator);  
           }
           else {
        ...
        DTMCursorIterator dtmIter = arg0NodeSet.iterRaw();
   	    ...
   	    try {
 	       ...
 	       throw new javax.xml.transform.TransformerException("FOAP0001 : An XPath 3.1 function call 'xml-to-json' evaluation resulted in a dynamic run-time error.", srcLocator);
 	    }
    ...
    /**
     * Method definition, to transform the supplied xdm node, to a 
     * corresponding json object (org.json.JSONObject, org.json.JSONArray) 
     * instance.
     * 
