 ...
 * tests for XSL higher order functions.
 * 
 * @author Mukul Gandhi <mukulg@apache.org>
 * 
 * @xsl.usage advanced
 */
public class XslHigherOrderFunctionTests extends W3CXslTransformTestsUtil {     
    ...
    @Test
    public void runXslHigherOrderFunctionTests() {    	
       runXslTestSet();
    }
