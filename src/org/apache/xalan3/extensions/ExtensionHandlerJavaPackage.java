...
import org.apache.xalan3.trace.ExtensionEvent;
 ...
 * <pre>
 *   xalan3://partial.class.name
 *   xalan3://
 *   http://xml.apache.org/xalan/java (which is the same as xalan3://)
 * </pre>
          ...
          if (methods[i].getName().equals(element))
          {
            ...
            if ( (paramTypes.length == 2)
              && paramTypes[0].isAssignableFrom(
                                     org.apache.xalan3.extensions.XSLProcessorContext.class)
              && paramTypes[1].isAssignableFrom(
                                       org.apache.xalan3.templates.ElemExtensionCall.class) )
            {
              return true;
            }
          }
