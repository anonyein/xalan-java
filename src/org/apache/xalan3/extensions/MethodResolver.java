    ...
    for(int i = 0; i < nMethods; i++)
    {
      ...
      if(method.getName().equals(name))
      {
        ...
        if ( (paramTypes.length == 2)
           && paramTypes[1].isAssignableFrom(org.apache.xalan3.templates.ElemExtensionCall.class)
                                         && paramTypes[0].isAssignableFrom(org.apache.xalan3.extensions.XSLProcessorContext.class) )
        {
          if ( ++bestScoreCount == 1 )
            bestMethod = method;
          else
      ...
      default:
        ...
        else                                  // must be an element call
        {
          return resultString + classObj.getName() + "." + funcName
                    + "(org.apache.xalan3.extensions.XSLProcessorContext, "
                    + "org.apache.xalan3.templates.ElemExtensionCall).";
        }
    }
