...
import org.apache.xalan3.extensions.ExpressionVisitor;
        ...
        implements TemplatesHandler, PrefixResolver, NodeConsumer
{
  ...
  {
    Class func = org.apache.xalan3.templates.FuncDocument.class;
    m_funcTable.installFunction("document", func);

    // func = new org.apache.xalan3.templates.FuncKey();
    // FunctionTable.installFunction("key", func);
    func = org.apache.xalan3.templates.FuncFormatNumb.class;
          ...
          throws org.xml.sax.SAXException
  {
    ...
    try
    {
      ...
      // testing purposes.
      if(
        "xalan3-doc-cache-off".equals(target) ||
        "xalan3:doc-cache-off".equals(target) ||
	   ("doc-cache-off".equals(localName) &&
	    ns.equals("org.apache.xalan3.xslt.extensions.Redirect") )
	 )
      {
	if(!(m_elems.peek() instanceof ElemForEach))
          throw new TransformerException
	    ("xalan3:doc-cache-off not allowed here!",
	     getLocator());
   ...
   *
   * @param msg An key into the {@link org.apache.xalan3.res.XSLTErrorResources}
   ...
   * exception.
   *
   * @param msg A key into the {@link org.apache.xalan3.res.XSLTErrorResources}
   * table, that is one of the WG_ prefixed definitions.
   * @param args An array of arguments for the given warning.
   * @param e An error which the SAXException should wrap.
   *
