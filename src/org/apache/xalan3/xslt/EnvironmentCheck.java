 ...
 * $Id$
 */
package org.apache.xalan3.xslt;
 ...
 * <code>
 * java org.apache.xalan3.xslt.EnvironmentCheck [-out outFile]
 * </code></p>
 * 
 ...
 *        exclude-result-prefixes="xalan3"&gt;
 *    &lt;xsl:output indent="yes"/&gt;
 *    &lt;xsl:template match="/"&gt;
 *      &lt;xsl:copy-of select="xalan3:checkEnvironment()"/&gt;
 *    &lt;/xsl:template&gt;
 *    &lt;/xsl:stylesheet&gt;
 * </pre></code></p>
 *  
...
public class EnvironmentCheck
{
   ...
   * errors - namely when a developer recompiles xalan3.jar on their
  ...
  {
    "xalan3.jar", "xalansamples.jar", "xalanj1compat.jar", "xalanservlet.jar",
        ...
        if (filename.indexOf(jars[i]) > -1)
        {
          ...
          if (f.exists())
          {
            ...
            try
            {
              ...
              // We won't bother reporting on the xalan3.jar apparent version
              // since this requires knowing the jar size of the xalan3.jar
              // before we build it. 
              // For other jars, eg. xml-apis.jar and xercesImpl.jar, we 
              // report the apparent version of the file we've found
              if (!("xalan3.jar".equalsIgnoreCase(jars[i]))) {
...
//              || "xalan3.jar".equalsIgnoreCase(jarName))
      {

        // For xalan3.jar and xerces.jar/xercesImpl.jar, which we ship together:
        // The jar is not from a shipped copy of xalan3-j, so
   ...
   *
   * Looks for version info in xalan3.jar from Xalan-J products.
   *
   * @param h Hashtable to put information in
   */
  protected void checkProcessorVersion(Hashtable h)
  {
    ...
    try
    {
      final String XALAN1_VERSION_CLASS =
        "org.apache.xalan3.xslt.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_VERSION_CLASS =
        "org.apache.xalan3.processor.XSLProcessorVersion";
  ...
  static 
  {
    ...
    jarVersions.put(new Long(857192), "xalan3.jar from xalan3-j_1_1");
    jarVersions.put(new Long(440237), "xalan3.jar from xalan3-j_1_2");
    jarVersions.put(new Long(436094), "xalan3.jar from xalan3-j_1_2_1");
    jarVersions.put(new Long(426249), "xalan3.jar from xalan3-j_1_2_2");
    jarVersions.put(new Long(702536), "xalan3.jar from xalan3-j_2_0_0");
    jarVersions.put(new Long(720930), "xalan3.jar from xalan3-j_2_0_1");
    jarVersions.put(new Long(732330), "xalan3.jar from xalan3-j_2_1_0");
    jarVersions.put(new Long(872241), "xalan3.jar from xalan3-j_2_2_D10");
    jarVersions.put(new Long(882739), "xalan3.jar from xalan3-j_2_2_D11");
    jarVersions.put(new Long(923866), "xalan3.jar from xalan3-j_2_2_0");
    jarVersions.put(new Long(905872), "xalan3.jar from xalan3-j_2_3_D1");
    jarVersions.put(new Long(906122), "xalan3.jar from xalan3-j_2_3_0");
    jarVersions.put(new Long(906248), "xalan3.jar from xalan3-j_2_3_1");
    jarVersions.put(new Long(983377), "xalan3.jar from xalan3-j_2_4_D1");
    jarVersions.put(new Long(997276), "xalan3.jar from xalan3-j_2_4_0");
    jarVersions.put(new Long(1031036), "xalan3.jar from xalan3-j_2_4_1");
    // Stop recording xalan3.jar sizes as of Xalan Java 2.5.0

    jarVersions.put(new Long(596540), "xsltc.jar from xalan3-j_2_2_0");
    jarVersions.put(new Long(590247), "xsltc.jar from xalan3-j_2_3_D1");
    jarVersions.put(new Long(589914), "xsltc.jar from xalan3-j_2_3_0");
    jarVersions.put(new Long(589915), "xsltc.jar from xalan3-j_2_3_1");
    jarVersions.put(new Long(1306667), "xsltc.jar from xalan3-j_2_4_D1");
    jarVersions.put(new Long(1328227), "xsltc.jar from xalan3-j_2_4_0");
    jarVersions.put(new Long(1344009), "xsltc.jar from xalan3-j_2_4_1");
    jarVersions.put(new Long(1348361), "xsltc.jar from xalan3-j_2_5_D1");
    // Stop recording xsltc.jar sizes as of Xalan Java 2.5.0

    jarVersions.put(new Long(1268634), "xsltc.jar-bundled from xalan3-j_2_3_0");

    jarVersions.put(new Long(100196), "xml-apis.jar from xalan3-j_2_2_0 or xalan3-j_2_3_D1");
    jarVersions.put(new Long(108484), "xml-apis.jar from xalan3-j_2_3_0, or xalan3-j_2_3_1 from xml-commons-1.0.b2");
    jarVersions.put(new Long(109049), "xml-apis.jar from xalan3-j_2_4_0 from xml-commons RIVERCOURT1 branch");
    jarVersions.put(new Long(113749), "xml-apis.jar from xalan3-j_2_4_1 from factoryfinder-build of xml-commons RIVERCOURT1");
    ...
    jarVersions.put(new Long(424490), "xalan3.jar from Xerces Tools releases - ERROR:DO NOT USE!");

    jarVersions.put(new Long(1591855), "xerces.jar from xalan3-j_1_1 from xerces-1...");
    jarVersions.put(new Long(1498679), "xerces.jar from xalan3-j_1_2 from xerces-1_2_0.bin");
    jarVersions.put(new Long(1484896), "xerces.jar from xalan3-j_1_2_1 from xerces-1_2_1.bin");
    jarVersions.put(new Long(804460),  "xerces.jar from xalan3-j_1_2_2 from xerces-1_2_2.bin");
    jarVersions.put(new Long(1499244), "xerces.jar from xalan3-j_2_0_0 from xerces-1_2_3.bin");
    jarVersions.put(new Long(1605266), "xerces.jar from xalan3-j_2_0_1 from xerces-1_3_0.bin");
    jarVersions.put(new Long(904030), "xerces.jar from xalan3-j_2_1_0 from xerces-1_4.bin");
    ...
    jarVersions.put(new Long(1808883), "xerces.jar from xalan3-j_2_2_D10,D11,D12 or xerces-1_4_3.bin");
    jarVersions.put(new Long(1812019), "xerces.jar from xalan3-j_2_2_0");
    jarVersions.put(new Long(1720292), "xercesImpl.jar from xalan3-j_2_3_D1");
    jarVersions.put(new Long(1730053), "xercesImpl.jar from xalan3-j_2_3_0 or xalan3-j_2_3_1 from xerces-2_0_0");
    jarVersions.put(new Long(1728861), "xercesImpl.jar from xalan3-j_2_4_D1 from xerces-2_0_1");
    jarVersions.put(new Long(972027), "xercesImpl.jar from xalan3-j_2_4_0 from xerces-2_1");
    jarVersions.put(new Long(831587), "xercesImpl.jar from xalan3-j_2_4_1 from xerces-2_2");
    jarVersions.put(new Long(891817), "xercesImpl.jar from xalan3-j_2_5_D1 from xerces-2_3");
    ...
    jarVersions.put(new Long(37485), "xalanj1compat.jar from xalan3-j_2_0_0");
    jarVersions.put(new Long(38100), "xalanj1compat.jar from xalan3-j_2_0_1");

    jarVersions.put(new Long(18779), "xalanservlet.jar from xalan3-j_2_0_0");
    jarVersions.put(new Long(21453), "xalanservlet.jar from xalan3-j_2_0_1");
    jarVersions.put(new Long(24826), "xalanservlet.jar from xalan3-j_2_3_1 or xalan3-j_2_4_1");
    jarVersions.put(new Long(24831), "xalanservlet.jar from xalan3-j_2_4_1");
    ...
    jarVersions.put(new Long(801714), "xalan3.jar from jaxp-1.1");
