...
import org.apache.xalan3.xsltc.compiler.Parser;
import org.apache.xalan3.xsltc.compiler.Stylesheet;
...
public class ClassGenerator extends ClassGen {
	...
	if (stylesheet.isMultiDocument()) {
	    _domClass = "org.apache.xalan3.xsltc.dom.MultiDOM";
	    _domClassSig = "Lorg/apache/xalan3/xsltc/dom/MultiDOM;";
	}
	else {
	    _domClass = "org.apache.xalan3.xsltc.dom.DOMAdapter";
	    _domClassSig = "Lorg/apache/xalan3/xsltc/dom/DOMAdapter;";
	}
	_applyTemplatesSig = "(" 
