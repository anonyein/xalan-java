...
public class SmartTransformerFactoryImpl extends SAXTransformerFactory 
{
     ...
     * uses org.apache.xalan3.xsltc.trax.TransformerFactory
     * to return Templates objects; and uses 
     * org.apache.xalan3.processor.TransformerFactory
    ...
    private void createXalanTransformerFactory() {
 	final String xalanMessage =
	    "org.apache.xalan3.xsltc.trax.SmartTransformerFactoryImpl "+
	    "could not create an "+
	    "org.apache.xalan3.processor.TransformerFactoryImpl.";
     ...
     * result. Uses the org.apache.xalan3.processor.TransformerFactory.
     ...
     * Uses the org.apache.xalan3.processor.TransformerFactory.
     ...
     * Uses the org.apache.xalan3.xsltc.trax.TransformerFactory.
     * @param source the stylesheet.
     ...
     * org.apache.xalan3.xsltc.trax.TransformerFactory.
     */
     ...
     * Uses org.apache.xalan3.processor.TransformerFactory.
     */
	...
	throws TransformerConfigurationException {
	try {
            return new org.apache.xalan3.xsltc.trax.TrAXFilter(templates);
        }
